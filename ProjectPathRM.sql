...
ALTER TABLE "calculations" ADD FOREIGN KEY ("id") REFERENCES "projects" ("calculation_id");
...
ALTER TABLE "projects_users" ADD FOREIGN KEY ("projects_id") REFERENCES "projects" ("id");

ALTER TABLE "projects_users" ADD FOREIGN KEY ("users_id") REFERENCES "users" ("id");
